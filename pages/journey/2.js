        ...
        <MainLayout>
            ...
            <div>
                ...
                <div className={s.productContainer}>
                    <img className={s.imgTour} src={data.items[1].imageUrl} alt={data.items[1].name} />

                    <div className={s.textProduct}>

                        <div className={s.wrapPost}>
                            <h2>{data.items[1].name}</h2>
                            <p>{data.items[1].info}</p>
                            <p><span className={s.spanTour}>1 день: </span>{data.items[1].plan1}</p>
                            <p><span className={s.spanTour}>2 день: </span>{data.items[1].plan2}</p>
                            <p><span className={s.spanTour}>Менеджер: </span>{data.items[1].contacts}</p>
                            <p><span className={s.spanTour}>Харчування: </span>{data.items[1].eating}</p>
                            <p><span className={s.spanTour}>Ціна: </span>{data.items[1].price}</p>
                            <p><span className={s.spanTour}>К-сть квитків: </span>{data.items[1].count}</p>

                            <div className={s.generalInfo}>
                                <p>
                                    У вартість ВХОДИТЬ:
                                    <br />
                                    - проїзд автобусом туристичного класу,
                                    <br />
                                    - проживання,
                                    <br />
                        ...
                        <div className={s.comments}>
                            ...
                            {data.items[1].comments.map(comment => (
                                <li key={comment.id}>
